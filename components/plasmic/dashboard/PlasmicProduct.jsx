...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: Ar4P-lqR3Z68/css
  ...
  const new$Queries = {
    revenueByDateRange: usePlasmicDataOp(() => {
      return {
        ...
        opId: "8fb6ea52-744c-4df4-8ba0-c766b1d0af42",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.8fb6ea52-744c-4df4-8ba0-c766b1d0af42.$.`,
    ...
    topProductsByQuantityLastYear: usePlasmicDataOp(() => {
      return {
        sourceId: "iHeaU9vvLuiWrGsLcqZQF2",
        opId: "43a6e789-4ffb-454b-bac2-f438f95904d0",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.43a6e789-4ffb-454b-bac2-f438f95904d0.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    totalProductCountByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "iHeaU9vvLuiWrGsLcqZQF2",
        opId: "bb21bd92-b6ea-4f41-bfc5-bb56bdafde3a",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.bb21bd92-b6ea-4f41-bfc5-bb56bdafde3a.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    unitsSoldByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "iHeaU9vvLuiWrGsLcqZQF2",
        opId: "fddbdfb1-576b-4bec-8de8-649cfe188585",
        userArgs: {
          query: [$state.start.value, $state.end.value]
        },
        cacheKey: `plasmic.$.fddbdfb1-576b-4bec-8de8-649cfe188585.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    listAllProductNames: usePlasmicDataOp(() => {
      return {
        sourceId: "iHeaU9vvLuiWrGsLcqZQF2",
        opId: "98c9972c-7500-480f-9cac-deffe200d506",
        userArgs: {},
        cacheKey: `plasmic.$.98c9972c-7500-480f-9cac-deffe200d506.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
            ...
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__rqXw)}
                  >
                    <DateTimeRangePicker
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__l4Pvf)}
                    >
                      <Statistic
                        className={classNames(
                          "__wab_instance",
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img___2DnZz)}
                              displayHeight={"auto"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__h3Hxt)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__mtfD)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__tKq4)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__uiAQg)}
                    >
                      <h2
                        className={classNames(
                          projectcss.all,
