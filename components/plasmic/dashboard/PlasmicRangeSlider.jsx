...
import Label from "../../Label"; // plasmic-import: RJiDREO3mZOz/component
...
import Description from "../../Description"; // plasmic-import: nNE6Cpv4uo7f/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: n6MR4BUmVqv8/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rPhtt)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__f8MUi)}>
        <div
