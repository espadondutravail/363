...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: IsjRuBP7nl7e/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__nv5Ud
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__nv5Ud__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__oVeKe
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__oVeKe__datePickerPopup"],
                  showTime: false
                };
                return <AntdDatePicker {...child$Props} />;
              })()}
